/* 
*     Ordena tres números de menor a major, gestionant totes les combinacions
*     Entrada: tres números. Sortida: números ordenats en ordre creixent
*/
...
public class TresEnOrdre {
    public static void main(String[] args) {
      ...
      if (primer < segon && primer < tercer && segon < tercer) {
        ...
        } else if (tercer < segon && tercer < primer && primer < segon) {
           System.out.println(tercer + ", " + primer + " i " + segon   );
        } else if (tercer < segon && tercer < primer && segon < primer){
           ...
           System.out.println(tercer + ", " + segon + " i " + primer );
        } else if (primer == tercer && tercer > segon && primer > segon) {
           System.out.println(segon + ", " + primer + " i " + tercer );
        } else if (primer == tercer && tercer < segon && primer < segon) {
           System.out.println(tercer + ", " + primer + " i " + segon );
        }
